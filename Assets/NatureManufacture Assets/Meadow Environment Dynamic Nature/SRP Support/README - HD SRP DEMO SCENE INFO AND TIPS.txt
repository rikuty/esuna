...
This ofc affect the performance. That's why number of  saved by baching is so huge but...performance at scene should be good anyway. 
...
BEFORE YOU START:
- you need Unity 2018.12.16f1 (beta engine versions have other hd srp version and it will be broken)
- you need HD SRP pipline 3.0.0 (if you use hihgher like 4.2.0 etc custom shaders will not work we have to recompile it but after beta will become public)
