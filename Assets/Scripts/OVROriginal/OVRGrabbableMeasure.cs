...
/// </summary>
public class OVRGrabbableMeasure : MonoBehaviour
{
    [SerializeField]
    ...
    protected OVRGrabberMeasure m_grabbedBy = null;
	...
	/// </summary>
    public OVRGrabberMeasure grabbedBy
    {
	...
	/// </summary>
	virtual public void GrabBegin(OVRGrabberMeasure hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
