...
/// </summary>
public class OVRGrabbableBothHands : MonoBehaviour
{
    [SerializeField]
    ...
    protected OVRGrabberBothHands m_grabbedBy = null;
	...
	/// </summary>
    public OVRGrabberBothHands grabbedBy
    {
	...
	/// </summary>
	virtual public void GrabBegin(OVRGrabberBothHands hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
