...
public class SecretarybirdCameraScript : MonoBehaviour {
	public GameObject target;
	public GameObject secretarybirdCamera;
	...
	void Update(){
		...
		secretarybirdCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
